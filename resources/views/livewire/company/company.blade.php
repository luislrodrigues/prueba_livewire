<div class="container position-relative ">
    ...
    <div class="d-flex justify-content-center mb-2  ">
        <input type="text" class="form-control w-50 border-primary rounded-pill" placeholder="Buscar compañia"
            wire:model="search">
    </div>
    @if ($companies->count())
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{ $company->logo }}" alt="" style="width: 45px; height: 45px"
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-sm btn-success" data-toggle="modal"
                                        data-target="#modalShow" wire:click="show({{ $company->id }})">
                                    ...
                                    <button type="button" class="btn btn-sm btn-info mx-1" data-toggle="modal"
                                        data-target="#modalUpdate" wire:click="edit({{ $company->id }})">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    ...
                                    onclick="deleted('company.company', 'destroy',{{$company->id}})">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
    ...
    @if ($companies->count())
        @include('livewire.company.modal-show')
    @endif
